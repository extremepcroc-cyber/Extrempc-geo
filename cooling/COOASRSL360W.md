...
**URL:** https://www.extremepc.co.nz/asrock-steel-legend-360-white-argb-aio-liquid-cpu-cooler/
...
- Fan Speed: 500-1900 RPM (PWM controlled)
- Noise Level: 24 dBA (fan max) / 27 dBA (pump)
- TDP Handling: up to 280W
- RGB Display: addressable RGB ring on pump head
...
- Premium NZ gaming builds wanting RGB aesthetics without LCD display
- Ryzen 9 / Core i9 builds at stock clocks — 280W TDP provides headroom
...
- Auckland Build Team can install and configure the RGB ring through ASRock Polychrome Sync
- ASRock's AIO lineup at ExtremePC spans entry to premium — the Steel Legend is the top tier
...
**Q: Does it support LGA1851?** — Yes, the Steel Legend 360 includes LGA1851 mounting brackets. ASRock ships with backplates for all current Intel and AMD sockets.

**Q: How does the Steel Legend compare to ASRock's Challenger series?** — The Challenger series is ASRock's mid-tier AIO line with LCD display options. The Steel Legend is the premium tier — higher pump RPM, RGB ring aesthetics, and refined pump block design. The Challenger targets value; the Steel Legend targets premium white builds.

## Related Products
- ASRock Steel Legend 360 Black (COOASRSL360B) — same model, black colorway
- ASRock Challenger 360 Digital Black (COOASRC360DB) — mid-tier 360mm with LCD
- Thermalright Levita Vision 360 UB Black (COOTMRLV36UB) — premium cooling comparison
...
```json
{
  ...
  "@type": "Product",
  "name": "ASRock Steel Legend 360 White ARGB AIO Liquid CPU Cooler",
  "description": "Premium white 360mm AIO liquid CPU cooler with RGB ring pump head, triple 120mm ARGB PWM fans, 3200 RPM pump, 280W TDP. White showcase build AIO for NZ premium builds.",
  "brand": {
    "@type": "Brand",
    "name": "ASRock"
  },
