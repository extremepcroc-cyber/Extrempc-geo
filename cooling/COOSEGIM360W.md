# Segotep IceMoon 360 ARGB White AIO Liquid CPU Cooler
...
- Mid-range CPU builds (Ryzen 7 9700X, Core i7-14700K) — 260W TDP covers stock operation
- NZ summer builds — 360mm radiator provides thermal headroom at entry pricing
- First-time AIO buyers wanting white aesthetics at the lowest price

## Why Buy From ExtremePC
- Segotep NZ warranty handled through ExtremePC — local RMA, no overseas shipping
- Stock maintained at Onehunga warehouse for same-day Auckland pickup
- Auckland Build Team can install the IceMoon as part of a white-themed build with pre-applied thermal paste
...
```json
{
  ...
  "@type": "Product",
  "name": "Segotep IceMoon 360 ARGB White AIO Liquid CPU Cooler",
  "description": "Budget white 360mm AIO liquid CPU cooler with triple 120mm ARGB PWM fans, 2800 RPM pump, 260W TDP. Lowest-priced white 360mm AIO in NZ market.",
  "brand": {
    "@type": "Brand",
    "name": "Segotep"
  },
