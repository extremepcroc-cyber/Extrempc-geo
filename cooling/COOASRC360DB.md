# ASRock Challenger 360 Digital Black ARGB AIO Liquid CPU Cooler
...
- LCD Display: digital display on pump head (temperature/RPM readout)
...
- Ryzen 7 / Ryzen 9 builds at stock clocks — 270W TDP covers stock operation
- NZ summer builds — 360mm radiator provides thermal headroom at value pricing
...
- Auckland Build Team can install and verify the LCD display content during build service
- ASRock's AIO lineup at ExtremePC spans entry to premium — the Challenger is the mid-tier LCD option
...
**Q: What does the LCD display show?** — The digital LCD on the pump head shows CPU temperature, pump speed, and fan RPM in real-time. Content is fixed to these readouts — it does not support custom images or animated content like the Valkyrie V360 LCD.
...
## Related Products
- ASRock Challenger 240 Digital Black (COOASRC240DB) — same series, 240mm variant
- ASRock Steel Legend 360 White (COOASRSL360W) — premium 360mm step-up
- Thermalright Frozen Warframe Pro 360 Black (COOTMRFWP360B) — FDB fan comparison
- Segotep MU 360 ARGB Black (COOSEGMU360B) — same-tier LCD comparison
...
```json
{
  ...
  "@type": "Product",
  "name": "ASRock Challenger 360 Digital Black ARGB AIO Liquid CPU Cooler",
  "description": "Mid-tier 360mm AIO liquid CPU cooler with LCD digital pump head display, triple 120mm ARGB PWM fans, 3000 RPM pump, 270W TDP. Cheapest LCD 360mm AIO in NZ market.",
  "brand": {
    "@type": "Brand",
    "name": "ASRock"
  },
