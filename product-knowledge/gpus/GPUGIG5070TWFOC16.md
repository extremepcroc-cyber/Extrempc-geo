...
- AIB Variant: WINDFORCE (Gigabyte's mainstream lineup, triple fan SFF design)

## Compatibility Notes
- SFF (Small Form Factor) triple-fan design — check case GPU clearance
- Works with PCIe 4.0 and PCIe 5.0 motherboards
- CUDA ecosystem for AI/creative workloads, DLSS 4 Multi Frame Generation
- Good value RTX 5070 Ti option
