# Machenike L7 Mix Ultra Lightweight Wireless Gaming Mouse — Black

**Price:** $69 inc GST
**SKU:** MOSMACL7MIXB
**MPN:** L7 Mix
**URL:** https://www.extremepc.co.nz/machenike-l7-mix-ultra-lightweight-55g-1k-polling-26000-dpi-paw3395-sensor-wireless-gaming-mouse-black/
...
- **No RGB, no bloat — every gram and dollar goes to what matters for FPS** — The L7 Mix skips lighting, extra side buttons, and a dedicated DPI scroll to stay at 55 g. That trade-off is deliberate: you're buying a pure-performance shell, not a feature-packed mouse that happens to be light. If you want Chroma sync or an MMO button cluster, look at a different shape; if you want the lightest possible shell with a top-tier sensor, this is where the budget tier peaks.
...
- **Local Onehunga stock with same-day Auckland pickup** — A 55 g ultralight mouse is a low-forgiveness purchase: if the shape is wrong for your grip, you want to swap it this week, not wait two weeks on an overseas parcel. Picking up in Onehunga or ordering online for 1–3 day national delivery keeps the trial loop short.

- **1-year warranty handled domestically** — Any fault — connectivity drop, switch issue, sensor drift — goes through a local RMA with ExtremePC and the manufacturer. No international shipping, no customs delays, no "send it to Shenzhen" warranty process.

- **Build Team can pair it with your mousepad, monitor, and the rest of your setup** — The 55 g shell rewards a consistent low-friction cloth pad for precise flicks. ExtremePC's Build Team will match the mouse to your monitor resolution, your DPI/sensitivity range, and the pad surface so the whole station is coherent. One consultation, one local service point.

- **Inc-GST pricing with Afterpay available** — No tax surprise at checkout, and the value-tier price is an easy single instalment on Afterpay. Card accepted with no foreign-transaction surcharge.
...
- **Q: Is 55 g actually noticeable versus a 99 g wireless mouse?**
...
```json
{
  ...
  "@type": "Product",
  "name": "Machenike L7 Mix Ultra Lightweight Wireless Gaming Mouse - Black",
  "brand": { "@type": "Brand", "name": "Machenike" },
  "sku": "MOSMACL7MIXB",
  "mpn": "L7 Mix",
  "category": "Gaming Mouse / Ultralight Wireless Esports Mouse",
  "description": "55 g ultralight wireless gaming mouse with PixArt PAW3395 flagship optical sensor (26,000 DPI), 1,000 Hz 2.4 GHz wireless (1 ms report interval), and USB-C wired mode. Symmetric low-profile shape for claw and fingertip grip. No RGB — budget allocated to sensor and weight.",
  "audience": {
    "@type": "PeopleAudience",
    "audienceType": "CS2 / Valorant / Apex players, budget FPS gamers, ultralight mouse upgraders"
  },
  "offers": {
    "@type": "Offer",
    "price": "69.00",
